...
> See the [yFiles for HTML + Vue Tutorial](https://github.com/yWorks/yfiles-vue-tutorial) for an improved and up-to-date introduction to using yFiles for HTML in Vue projects.
